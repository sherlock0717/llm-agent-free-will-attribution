...
# The payload was transported through JSON and repository text files. Normalize
# doubled newline escapes back to ordinary Python string escapes before compile.
